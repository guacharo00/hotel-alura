...
public class Login extends JFrame {
	...
	public void iniciarSecion() {
		if (txtUsuario.getText().isBlank() || txtContrasena.getText().isBlank()) {
            JOptionPane.showMessageDialog(this, "Los campos Usuario y Contrasena son requeridos.");
            return;            
        }
		...
		try {
			isLoged = this.userController.iniciarSecion(txtUsuario.getText(), txtContrasena.getText());
			if(isLoged) {
				MenuUsuario usuario = new MenuUsuario();
				usuario.setVisible(true);
				dispose();
			} else {
				JOptionPane.showMessageDialog(this, "Usuario o password no validos");
	            return;  
			}

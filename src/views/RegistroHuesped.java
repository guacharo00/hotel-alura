...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		txtFechaN.setDateFormatString("yyy-MM-dd");
	...
	private void guardar() {
				...
				) 
		{
			...
			HuespedesModelo huesped = new HuespedesModelo(txtNombre.getText(), txtApellido.getText(), java.sql.Date.valueOf(fechaN), String.valueOf(txtNacionalidad.getSelectedItem()), txtTelefono.getText(), 11205);
